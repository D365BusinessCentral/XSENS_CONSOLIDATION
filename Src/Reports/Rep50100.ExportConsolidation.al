report 50100 "Export Consolidation LT"
{
    ApplicationArea = Suite;
    Caption = 'IT Export Consolidation';
    ProcessingOnly = true;
    UsageCategory = Tasks;
                ...
                case FileFormat of
                    FileFormat::"Version 4.00 or Later (.xml)":
                        begin
                            ...
                            Consolidate.ExportToXML(ClientFileName + DelChr(Format(CurrentDateTime), '=', ':\/,APM-. ') + '_' + CompanyName + '.xml');
                        end;
                end;
            end;
    ...
    var
        ...
        RecBlobLists: Record "Blob Storage Blob Lists";
    ...
    begin
        /* Clear(RecBlobLists);
         ...
         RecBlobLists.SetRange(Container, RecCompanyInfo."Root Container");
         if not RecBlobLists.IsEmpty then
             Error('Blob file is already there in Root Container. Please try');*/
    ...
    var
        ...
        FileFormat: Option "Version 4.00 or Later (.xml)";
