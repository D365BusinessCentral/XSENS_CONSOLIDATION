codeunit 50100 Consolidate_LT
{
    ...
    procedure ImportFromXML(InputStream: InStream) //FileName: Text)
    var
        Consolidation: XMLport "Consolidation Import/Export";
    begin
        //LT-25082021
        Consolidation.SetSource(InputStream);//LT-25082021
    ...
    procedure ExportToXML(FileName: Text) OutputStream: OutStream//FileName: Text)
    var
        Consolidation: XMLport "Consolidation Import/Export";
    ...
    begin
        ...
        BlobService.PutBlob(RecCompanyInfo."Root Container", FileName, Instream);
